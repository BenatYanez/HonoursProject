...
vcftools --vcf /data/hartfield/atsweeps/analyses/Vcf_subset_AT.vcf --hapcount hapcount_BED_file_chrom${chrmnm}_20kb.bed --chr ${chrmnm} --min-alleles 2 --max-alleles 2 --remove-indels --max-missing 1 --min-meanDP 17 --max-meanDP 49 
--out /scratch/byanez/hapcount_chromosome_${chrmnm}
