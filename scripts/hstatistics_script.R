...
dev.copy(png,"H1vsRecombinationRate.png", width=1000,height=1000, units="px")
dev.off()
...
dev.copy(png,"H12vsRecombinationRate.png", width=1000,height=1000, units="px")
dev.off()
...
plot(x=1:4798 ,y=genomeh1table$h1,col=colrs, pch = 20, xlab = "Chromosome",xaxt= "n", main = "H1 values for all Chromosomes", ylab = "H1")
  ...
  dev.copy(png,"H1AllChromosomes.png",width=1000,height=1000, units="px")
  dev.off()
plot(x=1:4798 ,y=genomeh12table$h12, col=colrs, pch = 20, xlab = "Chromosome", xaxt= "n", main = "H12 values for all Chromosomes", ylab = "H12")
  ...
  axis(1,at=tickpos, labels=labl)
  dev.copy(png,"H12AllChromosomes.png",width=1000,height=1000, units="px")
  dev.off()
plot(x=1:4798 ,y=genomeh1table$h21, col=colrs, pch = 20, xlab = "Chromosome",xaxt= "n",  main = "H2/H1 values for all Chromosomes", ylab = "H2/H1")
  ...
  axis(1,at=tickpos, labels=labl)
  dev.copy(png,"H21AllChromosomes.png",width=1000,height=1000, units="px")
  dev.off()
...
dev.copy(png,"H12vsH21.png",width=1000,height=1000, units="px")
dev.off()
